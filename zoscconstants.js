...
//  ZoomOSC
//
//  Created by Richard Williamson on 20/12/2020.
//  Copyright © 2020 TOTTI. All rights reserved.
//

/*
//ifndef ZOSCConstants_h
 ZOSCConstants_h


//defs to allow conversion to javascript..
...
//ifndef AM_QT
    //if __APPLE__
          : x  [[NSString alloc] initWithUTF8String: x]
        // STR_DEF __unsafe_unretained NSString
    //endif
//endif
...
// ZOSCFullMessageMatch;

NS_INLINE ZOSCFullMessageMatch : {const char *message, const char *title, bool isPro, bool isNDI, ZOSCRequireHostMode requireCoHost, int argCount, const char *description  {
    ZOSCFullMessageMatch m;
    m.message : message;
    m.title : title;
    m.isPro : isPro;
    m.isNDI : isNDI;
...
REMOTE_PIN_GROUP : { TITLE:"remote pins", ARGS: "userString:userToPin", DESCRIPTION: "Select user to pin/upPin on remote device", MESSAGES: {
...
//screenshare
 ...
 ZOSC_MSG_PART_ SHARE : {USER_ACTION:"startWindowShare", TITLE:"Start window share", ISPRO: true, ISNDI: false, REQUIRE_HOST: enums.Host_Mode_None, MUST_FORWARD: true, PREFER_FORWARD: false, GROUP_SIZE: 1, ARG_COUNT: 1, DESCRIPTION: "Start window share for selected user and sent screen" },
